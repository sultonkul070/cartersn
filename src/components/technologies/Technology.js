                  ...
                  <div className="card h-100">
                    ...
                    <div className="card-body">
                      <h5>
                        ...
                        {tempObject && tempObject.brand}
                      </h5>
                      <h6>Model: {tempObject && tempObject.model}</h6>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4">
                  <div className="card h-100">
                    ...
                    <div className="card-body p-0">
                      <img
                        className="w-100"
                        src={tempObject && tempObject.imgURL}
                        alt="technology-img"
                      />
                    </div>
                  </div>
                ...
                <div className="col-lg-4">
                  <div className="card h-100">
                    ...
                    <div className="card-body">
                      ...
                      <ButtonGroup>
                        <Button onClick={() => changeCount(tempObject, false)}>
                          -
                        </Button>
                        <Button outline color="secondary" disabled>
                          {tempCount}
                        </Button>
                        <Button onClick={() => changeCount(tempObject, true)}>
                          +
                        </Button>
                      </ButtonGroup>
                    </div>
